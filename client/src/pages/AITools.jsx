...
//   return (
//     <div className="mx-auto w-11/12 max-w-[900px] py-10 text-richblack-5">
//       <h1 className="mb-2 text-3xl font-semibold">AI Learning Tools</h1>
//       <p className="mb-6 text-richblack-300">
//         Get instant explanations, practice quizzes, and a personalized roadmap — powered by AI.
//       </p>

//       <div className="mb-6 flex gap-x-2 border-b border-richblack-700">
//         {TABS.map((tab) => (
//           <button
//             key={tab.key}
...
//       <div className="rounded-md border border-richblack-700 bg-richblack-800 p-5">
//         <ActiveComponent />
//       </div>
//     </div>
//   );
